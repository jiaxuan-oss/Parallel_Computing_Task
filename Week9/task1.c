...
int main(int argc, char *argv[]) {
    ...
    */
    ...
    /************************************************************
    */
    MPI_Dims_create(size, ndims, dims); //use to divide the number of processor across multiple dimensions 
    if(my_rank == 0){
    ...
    ierr =0;
    ierr= MPI_Cart_create(MPI_COMM_WORLD, ndims, dims, wrap_around, reorder, &comm2D); //arrange processors into a grid for communication
